...
describe('application workflow (jsdom integration)', () => {
            ...
            results: [
              {
                ...
                priceCents: 12_950,
                priceAud: '129.50',
                itemPriceCents: 12_950,
                itemPriceAud: '129.50',
                shippingCents: 0,
                shippingAud: '0.00',
                estimatedTaxCents: null,
                estimatedTaxAud: null,
                totalPriceCents: 12_950,
                totalPriceAud: '129.50',
                comparisonPriceCents: 12_950,
                comparisonPriceAud: '129.50',
                priceBasis: 'item_plus_shipping',
                originalPriceText: 'A$129.50',
  ...
  it('persists manual evidence as a typed reference for an exact catalogue item', async () => {
    ...
    await user.type(
      ...
      'https://example.com/lw4570',
    );
    await user.type(screen.getByRole('textbox', { name: /unit or pack size/i }), '1 each');
