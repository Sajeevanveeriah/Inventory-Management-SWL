...
describe("source files are not excluded from version control", () => {
  it.skipIf(!gitAvailable())(
    "has no ignored file under any source directory",
    () => {
  ...
  it.skipIf(!gitAvailable())(
    "still excludes files that look like business data",
    () => {
  ...
  it.skipIf(!gitAvailable())(
    "tracks every file the application imports at build time",
    () => {
