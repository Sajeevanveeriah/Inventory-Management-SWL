...
const dataDir =
  dirFlag >= 0
    ? args[dirFlag + 1]
    : (process.env.SWL_DATA_DIR ?? join(HERE, "data"));
...
const ITEMS = [
  ...
  [
    "KC4-60",
    "Kaba C4 euro cylinder 60 mm nickel",
    4400,
    [4200, 4200, 4300, 4400],
  ],
  [
    "GN500-B",
    "Gainsborough G-Node 500 entrance set, black",
    12800,
    [12000, 12400, 12600, 12800],
  ],
  [
    "WH-HINGE-100",
    "Whitco 100 mm security hinge, stainless",
    950,
    [900, 900, 950, 950],
  ],
  [
    "LW3572",
    "Lockwood 3572 mortice lock body",
    15600,
    [14800, 15200, 15600, 15600],
  ],
  [
    "TES-KEY-LW4",
    "Silca LW4 key blank, brass (box of 50)",
    3900,
    [3600, 3700, 3800, 3900],
  ],
  [
    "CAM-CL001",
    "Camec CL001 caravan lock, white",
    2850,
    [2700, 2700, 2800, 2850],
  ],
  [
    "PAD-BRASS-40",
    "Generic brass padlock 40 mm (pack of 6)",
    2100,
    [1900, 2000, 2000, 2100],
  ],
  [
    "DL-DIGI-01",
    "Fictionville digital deadbolt, satin",
    18900,
    [17900, 18400, 18900, 18900],
  ],
...
store.putSources([
  {
    ...
    automatedAccessNote:
      "Server-side, rate limited and cached. Requires a credential plus explicit paid-call approval and budget.",
    enabled: true,
  },
  {
    id: "manual",
    ...
    automatedAccessNote: "Fallback for anything the provider cannot reach.",
    enabled: true,
  },
]);
