...
const seed = spawnSync(process.execPath, ['server/seed.mjs', '--data-dir', seedDataDir], {
  stdio: 'inherit',
});
if (seed.status !== 0) process.exit(seed.status ?? 1);
cpSync(seedDataDir, dataDir, { recursive: true, errorOnExist: true });

const server = spawn(process.execPath, ['tests/support/fixture-server.mjs', '--port', '4173'], {
